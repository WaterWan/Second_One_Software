...
public class FileDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 1; i < 400; i++) {
			...
			String strUrl = "http://desktop.nju.edu.cn:8080/jiaowu/Data/Photos/15/151099" + myInteger2String(i) + ".JPG";
			// new一个URL对象
...
//				InputStream inStream = conn.getInputStream();
				...
				File imageFile = new File("E:\\图片及音频\\未知15", myInteger2String(count) + ".jpg");
				// 创建输出流
